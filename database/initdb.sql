...
CREATE TABLE "token" (
    ...
    "token_de_acesso" TEXT UNIQUE NOT NULL,
    "token_de_refresh"TEXT UNIQUE,
    "expiracao_token_de_acesso"  TIMESTAMP NOT NULL,
    "expiracao_token_de_refresh"  TIMESTAMP,
    "criado_em" TIMESTAMP DEFAULT (CURRENT_TIMESTAMP),
    "atualizado_em" TIMESTAMP
);
...
ALTER TABLE "token" ADD FOREIGN KEY ("acesso_id") REFERENCES "acesso" ("id") ON DELETE CASCADE;

ALTER TABLE "boletim_saidas" ADD FOREIGN KEY ("usuario_responsavel_preenchimento_id") REFERENCES "usuario"("id");
